...
def parse() -> tuple:
    ...
    init_password_parser = subparser.add_parser("init", help="set up a master password to initialize the password pit of doom and despair")
    ...
    exp_password_parser = subparser.add_parser("exp", help="exports all the saved passwords to a csv file")
    ...
    exp_password_parser.add_argument("-p", "--path", help="the path to save the csv file to")
    init_password_parser.add_argument("-i", "--importp", help="initialize the database from a csv file")
